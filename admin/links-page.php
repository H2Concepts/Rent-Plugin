...
<div class="wrap">
    ...
    <div class="federwiegen-tab-content">
        ...
        switch ($active_tab) {
            case 'add':
                if (empty($variants) || empty($extras) || empty($durations)):
                ?>
                <div class="federwiegen-tab-section">
                    ...
                    <ul>
                        ...
                        <?php if (empty($extras)): ?><li>❌ <a href="<?php echo admin_url('admin.php?page=federwiegen-extras&category=' . $selected_category); ?>">Extras hinzufügen</a></li><?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo admin_url('admin.php?page=federwiegen-links&category=' . $selected_category . '&tab=list&delete=' . $link->id); ?>" class="button button-small" onclick="return confirm('Sind Sie sicher?')">Löschen</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
